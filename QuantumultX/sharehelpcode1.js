...
const jsname='互助码提交'
const $ = Env(jsname)
const dd_shareCode1 = $.getdata('T010_bgtCktBsACjVWnYaS5kRrbA') ;
const jx_shareCode1 = $.getdata('_sY24NnwZZou3cwcKrKclg==') ;
const zd_shareCode1 = $.getdata('kjy4v2nrb36hsxzyovfhb7xztq') ;
const nc_shareCode1 = $.getdata('3c1a11f1cae1475499ae7085f517438f') ;
const mc_shareCode1 = $.getdata('MTE1NDUyMjEwMDAwMDAwMzYyNDI3Mjk=') ;
const joy_shareCode1 = $.getdata('QubsIcYNbZQ=') ;

const dd_shareCode2 = $.getdata('T0225KkcRhwcplTXJB-nnfMJdQCjVWnYaS5kRrbA') ;
const jx_shareCode2 = $.getdata('KcDoN1P7d9iP4BFX6UHOmA==') ;
const zd_shareCode2 = $.getdata('olmijoxgmjuty5mdcpkgmkiyerzkreikajf5kca') ;
const nc_shareCode2 = $.getdata('937320b6fe4b4891827690bd304e947a') ;
