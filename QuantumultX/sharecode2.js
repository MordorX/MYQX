...
const shareCodes = [
  {
    zd: $.getdata("zd_shareCode1") || "suqg5cye47cqmlwlvkrl45t2qli7xbfcqvjod7q",
    nc: $.getdata("nc_shareCode1") || "dc947ab19f9940089479d49937bc73fb",
    mc: $.getdata("mc_shareCode1") || "MTE1NDQ5OTIwMDAwMDAwNDE5MTk5Mzc=",
    ddgc: $.getdata("dd_shareCode1") || "P04z54XCjVWnYaS5m9cZxOirhs915NZDWyekg",
    jxgc: $.getdata("jx_shareCode1") || "",
  },
  {
    zd: $.getdata("zd_shareCode2") || "e7lhibzb3zek376pingyor4324wmae5dhtj6y4q",
    nc: $.getdata("nc_shareCode2") || "1f198dd82a044244b1de06ded912af39",
    mc: $.getdata("mc_shareCode2") || "MTE1NDAxNzgwMDAwMDAwNDE4ODkwNDc=",
    ddgc: $.getdata("dd_shareCode2") || "P04z54XCjVWnYaS5m9cZ2SujipCwIAJ60biPls",
    jxgc: $.getdata("jx_shareCode2") || "_m8qoB936tuFZtxg0OocIg==",
  },
];
$.result = [];
