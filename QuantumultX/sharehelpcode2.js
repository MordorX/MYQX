...
const jsname='互助码提交'
const $ = Env(jsname)
const dd_shareCode1 = $.getdata('T0225KkcREhKo1yCKRPzwqIIcACjVWnYaS5kRrbA') ;
const jx_shareCode1 = $.getdata('_m8qoB936tuFZtxg0OocIg==') ;
const zd_shareCode1 = $.getdata('e7lhibzb3zek376pingyor4324wmae5dhtj6y4q') ;
const nc_shareCode1 = $.getdata('1f198dd82a044244b1de06ded912af39') ;
const mc_shareCode1 = $.getdata('MTE1NDAxNzgwMDAwMDAwNDE4ODkwNDc=') ;
const joy_shareCode1 = $.getdata('ErccMDcnLgZaHVXK2tzXaat9zd5YaBeE') ;

const dd_shareCode2 = $.getdata('T0205KkcM0RqkiOVeHqm06hZCjVWnYaS5kRrbA') ;
const jx_shareCode2 = $.getdata('jx_shareCode2') ;
const zd_shareCode2 = $.getdata('suqg5cye47cqmlwlvkrl45t2qli7xbfcqvjod7q') ;
const nc_shareCode2 = $.getdata('dc947ab19f9940089479d49937bc73fb') ;
const mc_shareCode2 = $.getdata('MTE1NDQ5OTIwMDAwMDAwNDE5MTk5Mzc=') ;
const joy_shareCode2 = $.getdata('vzEoO0aTHV4A8Xi8DjvUqQ==') ;
